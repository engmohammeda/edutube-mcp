...
Configuration can come from MCP client `env`, shell environment variables, a local `.env` file during development, or the config file created by `edutube-mcp setup`.
